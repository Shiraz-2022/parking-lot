import { GetSlotsByColorUseCase } from '../../../src/app/use-cases/GetSlotsByColorUseCase';
...
import { GetSlotsByColorDto } from '../../../src/app/dto/GetSlotsByColorDto';
import { ParkingLotRepository } from '../../../src/domain/repositories/parking-lot/parking-lot.repository';

describe('GetSlotsByColorUseCase', () => {
    let useCase: GetSlotsByColorUseCase;
    ...
    beforeEach(() => {
        ...
        useCase = new GetSlotsByColorUseCase(mockRepository);
    });

    it('should find slots by vehicle color', async () => {
        // Arrange
        const parkingLotId = 'test-parking-lot';
        const dto: GetSlotsByColorDto = {
            color: Color.WHITE,
            parkingLotId,
        };
        ...
        expect(result!.every(s => s.vehicle!.color === Color.WHITE)).toBeTruthy();
